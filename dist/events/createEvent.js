...
const onCreateEvent = (event) => __awaiter(void 0, void 0, void 0, function* () {
...
export const initEventForm = () => {
    eventFormElem === null || eventFormElem === void 0 ? void 0 : eventFormElem.addEventListener('submit', onCreateEvent);
};
